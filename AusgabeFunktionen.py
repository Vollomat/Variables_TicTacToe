def delimitation(s, userInputOfGameSize):
  '''Erwartet einen String (leer beim 1. Aufruf) und eine User-Eingabe von der        Spielfeldgröße. Diese Funktion dient dazu, dass bei der Ausgabe sich die Felder des Tic-Tac-Toe-Spielfelds gut abgrenzen lassen. Die Funktion liefert den ,,Abgrenzungs-String" zurück, abhängig der Spielfeldgröße.
  '''
